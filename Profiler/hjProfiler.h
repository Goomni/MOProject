...
#define PROFILING MULTI_THREAD_PROFILING
...
#define BeginProfiling(x) g_Profiler.Begin(x)
#define EndProfiling(x) g_Profiler.End(x)
...
public:
	...
	void BeginProfiling(const char* ProfileName);
	void EndProfiling(const char* ProfileName);
	void WritingProfile();
	void WritingProfile(FILE *fp);
	void InitializeProfiler();
...
public:
	...
	void BeginProfiling(const char *pProfileName);
	void EndProfiling(const char *pProfileName);
...
#define _BeginProfiling(x) g_ProfilerManager.BeginProfiling(x)
#define _EndProfiling(x) g_ProfilerManager.EndProfiling(x)
