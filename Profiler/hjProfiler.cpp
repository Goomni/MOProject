...
void CProfiler::BeginProfiling(const char* ProfileName)
{
	int ProfileNumber = 0;
...
void CProfiler::EndProfiling(const char* ProfileName)
{
...
void CProfilerManager::BeginProfiling(const char *pProfileName)
{
	...
	pProfiler->BeginProfiling(pProfileName);
}

void CProfilerManager::EndProfiling(const char *pProfileName)
{
	((CProfiler*)(TlsGetValue(m_iTLSIndex)))->EndProfiling(pProfileName);
}
